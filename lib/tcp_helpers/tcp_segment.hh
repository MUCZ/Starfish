...
class TCPSegment {
  ...
  public:
    ...
    // calculates how many sequence numbers a
    // segment occupies (including the fact that the SYN and FIN flags
    // each occupy one sequence number, along with each byte of the payload).
